...
def do_eval(gt_annos,
    ...
    for index,_ in enumerate(gt_annos):
        gt_annos[index]["truncated"] = np.array([0.0],dtype=np.float32)
        gt_annos[index]["occluded"] = np.array([0.0],dtype=np.float32)
        gt_annos[index]["alpha"] = np.array([-5.0],dtype=np.float32)
        gt_annos[index]["bbox"] = np.array([212.03621, 184.37099, 268.63672, 214.25945],dtype=np.float32).reshape(1,-1)

    for index,_ in enumerate(dt_annos):
        dt_annos[index]["truncated"] = np.array([0.0],dtype=np.float32)
        dt_annos[index]["occluded"] = np.array([0.0],dtype=np.float32)
        dt_annos[index]["alpha"] = np.array([-5.0],dtype=np.float32)
        dt_annos[index]["bbox"] = np.array([212.03621, 184.37099, 268.63672, 214.25945],dtype=np.float32).reshape(1,-1)
    ...
    mAP_bbox = np.zeros((1,3,2))
    mAP_aos = np.zeros((1,3,2))
    mAP_bbox_R40 = np.zeros((1,3,2))
    mAP_aos_R40 = np.zeros((1,3,2))

    # add code end
    return mAP_bbox, mAP_bev, mAP_3d, mAP_aos, mAP_bbox_R40, mAP_bev_R40, mAP_3d_R40, mAP_aos_R40
    # return 0, mAP_bev, mAP_3d, 0, 0, mAP_bev_R40, mAP_3d_R40, 0
